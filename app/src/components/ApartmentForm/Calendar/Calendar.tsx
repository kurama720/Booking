                ...
                renderInput={(startProps, endProps) => (
                    <>
                        <div className='flex flex-col items-start justify-start'>
                            <label htmlFor="check_in" className='text-xs font-body text-gray-700'>Check-in</label>
                            <div className='border border-gray-300 rounded-l-md flex items-center justify-center'>
                                <span className='mx-2'><CalendarIcon className='text-gray-500 w-4 h-4'/></span>
                                <TextField
                                    {...startProps}
                                    label={''}
                                    id='check_in'
                        ...
                        <div className='flex flex-col items-start justify-start'>
                            <label htmlFor="check_out" className='text-xs font-body text-gray-700'>Check-out</label>
