...
function AuthMenuItemLogin({
  ...
  return (
    <div className="w-56 h-60 shadow-md rounded-md absolute  top-12 flex flex-col 1.5xl:left-[43.3%] lg:left-[11.2%] 3xl:left-[82%] 4xl:left-[85%] 5xl:left-[89%] xlg:left-[77.5%] mlg:left-[76.2%] 3.5xl:left-[83%] 1xl:left-[80%] 3.75xl:left-[85%] 6xl:left-[90%]">
      ...
      <button className="font-body font-medium text-sm text-gray-700 w-full mb-[0.6875rem] mt-4 ml-[0.8125rem] flex">
        Wishlist
      </button>
      <hr />
