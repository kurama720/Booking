...
function AuthMenuItemLogout({
  ...
  return (
    <div className="w-56 h-[7.75rem] shadow-md rounded-md absolute top-12 flex flex-col bg-white rounded-md 1.5xl:left-[84.3%] lg:left-[11.2%] 3xl:left-[85%] 4xl:left-[87.6%] 5xl:left-[91%] xlg:left-[80.6%] mlg:left-[76.2%] 3.5xl:left-[85.6%] 1xl:left-[83%] 3.75xl:left-[87.4%] 6xl:left-[92%]">
      <button
        type="button"
