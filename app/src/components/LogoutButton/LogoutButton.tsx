...
const LogoutButton = ({activeLogout, handleLogoutPopUpStatus}: LogoutButtonProps) => {
  ...
  return (
      !activeLogout ? (
          ...
          <div className='h-full flex justify-center items-center ' onClick={e => e.stopPropagation()}>
