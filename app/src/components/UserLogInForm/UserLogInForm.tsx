...
const UserLogInForm = () => {
  ...
  const refContainEmail = useRef<HTMLInputElement>(null);
  const [emailPostfix, isEmailPostfix] = useState<boolean>(false);
  ...
  useEffect(() => {
    ...
    if (postfix === "com") {
      ...
      isEmailPostfix(false);
    }
  }, [visiblePassword, token, postfix]);
